...
public class EAggregator extends ElementF<F1<Resource<Matrix<Color>>, Integer>> {
	...
	public EAggregator(HasOutput<Aggregator.F_Aggregator> outFAggregator, HasOutput<ColorFunction> outColorFunction, HasOutput<Vec3> outSize, HasOutput<Long> outSeed) {
	...
	protected void buildItUp() {
		aggregator = inFAggregator.get().at(inColorFunction.get(), inSize.get(), inSeed.get());
